...
public sealed record V1Alpha1AdmissionDecisionSpecWire(string WorkloadRef, long WorkloadGeneration, string NodeRef, string BundleDigest, string PolicyDigest, IReadOnlyList<string>? ApprovedActions, string SessionAuthority, string IsolationProfile, V1Alpha1ResourceRequirementsWire? ResourceLimits, IReadOnlyList<string>? CredentialGrantDigests, V1Alpha1NetworkScopeWire? NetworkScope, V1Alpha1EvidenceRequirementsWire? EvidenceRequirements, DateTimeOffset ExpiresAt);
